...
var appViews = [
	...
	extensionsConfig.nunjucksPaths.reverse(),
...
// Serve govuk-frontend in /node_modules
...
app.use((req, res, next) => {
	...
	Object.assign(res.locals, {
		pluginConfig: {
			scripts: extensions.getPublicPaths(extensionsConfig.scripts),
			stylesheets: extensions.getPublicPaths(extensionsConfig.scripts)
		}
	})
...
if (useDocumentation) {
	var documentationViews = [
		...
		extensionsConfig.nunjucksPaths,
